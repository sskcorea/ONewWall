...
$.fn.spin=function(b){this.each(function(){var c=$(this),a=c.data();a.spinner&&(a.spinner.stop(),delete a.spinner);if(b!==false)a.spinner=(new Spinner($.extend({color:c.css("color")},b))).spin(this)});return this};